...
Definition _heap : ident := 53%positive.
...
Definition _root_mark : ident := 59%positive.
Definition ___i64_shr : ident := 37%positive.
Definition ___builtin_addl : ident := 4%positive.
Definition _sz : ident := 58%positive.
