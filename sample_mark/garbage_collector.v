...
Definition ___i64_shr : ident := 32%positive.
...
Definition _hd : ident := 54%positive.
Definition ___i64_utod : ident := 24%positive.
Definition ___i64_dtou : ident := 22%positive.
...
Definition _sz : ident := 57%positive.
...
Definition ___builtin_bswap16 : ident := 36%positive.
Definition ___i64_shl : ident := 31%positive.
Definition ___builtin_va_arg : ident := 14%positive.
Definition _pointer_or_data : ident := 6%positive.
Definition ___i64_utof : ident := 26%positive.
...
Definition ___i64_sdiv : ident := 27%positive.
Definition ___i64_sar : ident := 33%positive.
Definition _i : ident := 56%positive.
Definition ___i64_stof : ident := 25%positive.
Definition ___builtin_va_copy : ident := 15%positive.
Definition _main : ident := 60%positive.
Definition ___builtin_bswap : ident := 34%positive.
Definition ___i64_smod : ident := 29%positive.
Definition _ct : ident := 55%positive.
Definition ___builtin_bswap32 : ident := 35%positive.
Definition ___i64_umod : ident := 30%positive.
Definition ___i64_stod : ident := 23%positive.
