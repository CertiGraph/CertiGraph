...
Module Info.
  ...
  Definition source_file := "sample_mark/copy_bi.c"%string.
...
Definition _copy : ident := 61%positive.
Definition _l : ident := 3%positive.
Definition _l0 : ident := 59%positive.
...
Definition _x0 : ident := 58%positive.
              ...
              (Ssequence
                ...
                (Ssequence
                  (Ssequence
                    ...
                    (Sset _l0 (Etempvar _t'2 (tptr (Tstruct _Node noattr)))))
                  (Ssequence
                    (Sassign
                      (Efield
                        (Ederef (Etempvar _x0 (tptr (Tstruct _Node noattr)))
      ...
      (Ssequence
        ...
        (Ssequence
          ...
          (Ssequence
            ...
            (Sset _y (Etempvar _t'1 (tptr (Tstruct _Node noattr)))))))))
  (Sreturn (Some (Econst_int (Int.repr 0) tint))))
|}.
...
(_main :: _n :: _copy :: _mallocN :: ___builtin_debug ::
