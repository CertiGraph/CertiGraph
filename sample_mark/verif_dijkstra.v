                ...
                *)
                    ...
                    other popped verices *)
                        ...
                        is le first. then done.
                              ...
                              rewrite H73.
                              assert (careful_add (path_cost g p2mom') inf = inf). {
                                apply careful_add_inf.
                                apply path_cost_pos; trivial.
                              }
                              unfold VType in *.
                              rewrite H75.
 ...
 *)
                                  ...
                                  assert (In mom' (get_popped priq_contents')). {
                                    ...
                                    rewrite get_popped_unchanged in H64; auto; omega.
                                  }
                                  unfold VType in *.
                                  unfold path_globally_optimal in H62.
  ...
  (* done, see H77 *)
                                  ...
                                  2: {
                                    ...
                                    - rewrite careful_add_dirty; trivial.
                                      rewrite upd_Znth_same in H59 by omega.                                      omega.
                                    - unfold careful_add.
...
dist[i] <= dist[k] + len(edge k i) <= path_cost p'.
   ...
   dist[i] < path_cost p' because of Inv2.
                ...
                --- unfold inv_unseen; intros.
                    ...
                    rewrite H58 in H43.
                     admit. (* I think I need a stronger invariant *)
