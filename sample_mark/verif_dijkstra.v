        ...
        -- (* We start the for loop as planned -- 
           ...
           ++ (* ... in fact, any vertex that is 
             ...
             ** intros.
                ...
                specialize (H41 _ H43).
                destruct H41 as [? [? [? ?]]].
                destruct H40.
                rewrite <- get_popped_irrel_upd in H41, H44; try omega.
                split; trivial.
                all: rewrite H11.
                apply (step_in_range2 g p2mom'); trivial.
                apply (step_in_range g p2mom'); trivial.
             ...
             *** intros.
                 ...
                 ---- destruct H68 as [? [? [? [? ?]]]].
                      ...
                      ++++ rewrite Forall_forall; intros.
                           ...
                           destruct H69.
                           rewrite H76 in H77.
                           rewrite get_popped_meaning in H77.
                           2: rewrite upd_Znth_Zlength; omega.
                           rewrite upd_Znth_same in H77; omega.
                 ---- rewrite Forall_forall; intros.
                      rewrite Forall_forall in H69.
                      ...
                      rewrite <- get_popped_irrel_upd in H69, H72; try omega.
                      split; trivial.
                      ++++ intro. rewrite get_popped_meaning in H72.
                           2: rewrite upd_Znth_Zlength; omega.
                           rewrite H76 in H72.
                           rewrite upd_Znth_same in H72.
                           omega.
                           omega.
                      ++++ intro. rewrite get_popped_meaning in H69.
                           2: rewrite upd_Znth_Zlength; omega.
                           rewrite H76 in H69.
                           rewrite upd_Znth_same in H69.
                           omega.
                           omega.                   
     --- intros.
         ...
         +++ destruct H61 as [? [? [? [? ?]]]].
             ...
             *** rewrite Forall_forall; intros.
                 ...
                 ---- rewrite H34.
                      apply (step_in_range2 g p2mom); trivial.
                 ---- rewrite Forall_forall in H62.
                      specialize (H62 _ H70).
                      destruct H62 as [? [? [? ?]]].
                      intro. rewrite H74 in H71.
                      apply H43. trivial.
         +++ rewrite Forall_forall; intros.
             rewrite Forall_forall in H62.
             specialize (H62 _ H66).
             destruct H62 as [? [? [? ?]]].
             destruct H61.
             split3; [| |split]; trivial;
             ...
             *** intro. rewrite H71 in H62. apply H43; trivial.
             *** rewrite H33. apply (step_in_range2 g p2mom); trivial.
             *** intro. rewrite H71 in H67.
                 apply H43. trivial. 
         ...
         +++ intros. rewrite <- Heqmom.
             ...
             *** destruct H66 as [? [? [? [? ?]]]].
                 split3; [| |split3]; trivial.
                 ---- rewrite upd_Znth_diff in H71;
                        try omega; trivial.
                      admit. (* doable, but... *)
                      intro. (* need more info *)
                      admit.
                 ---- rewrite Forall_forall; intros.
                      rewrite Forall_forall in H72.
                      specialize (H72 _ H73).
                      unfold VType in *.
                      rewrite upd_Znth_diff in H72; try omega; trivial.
                      ++++ rewrite H34.
                           apply (step_in_range2 g p2mom'); trivial.
                      ++++ intro. rewrite Forall_forall in H67.
                           specialize (H67 _ H73).
                           destruct H67 as [_ ?].
                           rewrite H74 in H67.
             ...
             *** rewrite Forall_forall; intros.
                 ...
                 destruct H67 as [? [? [? ?]]].
                 rewrite <- get_popped_irrel_upd in H67, H70; try omega; trivial.
                 split3; [| |split]; trivial.
                 ---- rewrite H33.
                      destruct H66.
                      apply (step_in_range2 g p2mom');
                        trivial.
                 ---- intro. rewrite H73 in H70.
  ...
  ** rewrite Int.signed_repr in H42
     ...
     --- intros.
         ...
         +++ rewrite Forall_forall; intros.
             ...
             destruct H59 as [? [? [? ?]]].
             split; trivial.
         +++ admit. (* need to add to the weaker bit also *)
         +++ intros.
