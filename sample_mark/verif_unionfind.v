...
Proof.
  ...
  - (* p0 = find(p); *)
    ...
    forward. unlocalize [whole_graph sh (Graph_gen_redirect_parent g' x root H5 H6 H8)].
    ...
    + rewrite H9. Exists (Graph_gen_redirect_parent g' x root H5 H6 H8). Exists root. rewrite H9. entailer!. split.
