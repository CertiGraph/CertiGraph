...
Definition ___stringlit_5 : ident := 76%positive.
Definition _argc : ident := 80%positive.
Definition _argv : ident := 81%positive.
Definition _curr : ident := 72%positive.
Definition _dijkstra : ident := 79%positive.
Definition _dist : ident := 75%positive.
Definition _getPaths : ident := 77%positive.
Definition _graph : ident := 62%positive.
...
Definition _pq : ident := 56%positive.
Definition _pq_not_emp : ident := 61%positive.
Definition _prev : ident := 73%positive.
Definition _printPath : ident := 74%positive.
Definition _print_graph : ident := 71%positive.
Definition _printf : ident := 54%positive.
Definition _rand : ident := 52%positive.
Definition _random : ident := 64%positive.
Definition _setup : ident := 65%positive.
...
Definition f_dijkstra := {|
  ...
  fn_temps := ((_i, tint) :: (_j, tint) :: (_u, tint) :: (_t'1, tint) ::
              ...
              (Sassign
                (Ederef
                  (Ebinop Oadd (Evar _pq (tarray tint 8)) (Etempvar _i tint)
                    (tptr tint)) tint) (Etempvar _t'9 tint))))))
      (Sset _i
        (Ebinop Oadd (Etempvar _i tint) (Econst_int (Int.repr 1) tint) tint))))
  (Ssequence
    (Sassign
...
Definition f_main := {|
  ...
  fn_temps := ((_i, tint) :: (_j, tint) :: (_src, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _src (Econst_int (Int.repr 0) tint))
    (Ssequence
      (Scall None
...
((___stringlit_4, Gvar v___stringlit_4) ::
 ...
 (_pq_not_emp, Gfun(Internal f_pq_not_emp)) ::
...
(_main :: _dijkstra :: _getPaths :: _printPath :: _print_graph :: _setup ::
 _pq_not_emp :: _popMin :: _time :: _printf :: _srand :: _rand ::
