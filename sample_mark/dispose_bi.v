...
Definition _dispose : ident := 61%positive.
...
Definition _mark : ident := 59%positive.
Definition _r : ident := 4%positive.
Definition _root_mark : ident := 58%positive.
Definition _spanning : ident := 60%positive.
...
(_main :: _dispose :: _spanning :: _mark :: _free :: ___builtin_debug ::
