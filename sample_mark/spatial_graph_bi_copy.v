...
Instance SGP_VST (sh: share) : SpatialGraphPred addr (addr * LR) (addr * addr * addr) unit pred.
...
Instance sSGG_VST (sh: wshare): @sSpatialGraph_Graph_Bi pSGG_VST addr (addr * LR).
