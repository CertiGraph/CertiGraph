Module Type Mgraphmark.
  ...
  Parameter update : A -> node -> bool -> node -> node -> A -> formula.
  Axiom axiom_1 : forall v G1 G2 G G3 x l r, valid (imp (and (lookup G x v l r) (and (mark G r G1) (and (neq v true) (and (mark G2 l G3) (update G1 x true l r G2))))) (and (mark G x G3) (lookup G3 x true l r))).
  Axiom axiom_2 : forall v G1 G2 G G3 x l r, valid (imp (and (lookup G x v l r) (and (mark G l G1) (and (neq v true) (and (mark G2 r G3) (update G1 x true l r G2))))) (and (mark G x G3) (lookup G3 x true l r))).
  Axiom axiom_3 : forall v G1 G2 G G3 x l r, valid (imp (and (lookup G x v l r) (and (mark G r G1) (and (neq v true) (and (mark G1 l G2) (update G2 x true l r G3))))) (and (mark G x G3) (lookup G3 x true l r))).
  Axiom axiom_4 : forall v G1 G2 G G3 x l r, valid (imp (and (lookup G x v l r) (and (mark G l G1) (and (neq v true) (and (mark G1 r G2) (update G2 x true l r G3))))) (and (mark G x G3) (lookup G3 x true l r))).
  Axiom axiom_5 : forall v G1 G2 G G3 x l r, valid (imp (and (lookup G x v l r) (and (update G x true l r G1) (and (neq v true) (and (mark G1 r G2) (mark G2 l G3))))) (and (mark G x G3) (lookup G3 x true l r))).
  Axiom axiom_6 : forall v G1 G2 G G3 x l r, valid (imp (and (lookup G x v l r) (and (update G x true l r G1) (and (neq v true) (and (mark G1 l G2) (mark G2 r G3))))) (and (mark G x G3) (lookup G3 x true l r))).
  ...
  Axiom axiom_8 : forall l r x G, valid (imp (lookup G x true l r) (mark G x G)).
