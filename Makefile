...
PRIM_FILES = \
  ...
  verif_prim3.v verif_noroot_prim3.v 
...
# clightgen:
#	../CompCert/clightgen -DCOMPCERT -normalize -isystem . priq/priq_arr.c prim/prim3.c prim/noroot_prim3.c dijkstra/dijkstra1.c dijkstra/dijkstra2.c dijkstra/dijkstra3.c
