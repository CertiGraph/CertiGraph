...
SAMPLE_MARK_FILES = \
  env_mark_bi.v verif_mark_bi.v env_garbage_collector.v env_dispose_bi.v verif_dispose_bi.v verif_mark_bi_dag.v env_copy_bi.v spatial_graph_bi_mark.v spatial_graph_bi_copy.v unionfind.v env_unionfind.v spatial_graph_glist.v verif_unionfind.v verif_unionfind_slim.v verif_unionfind_rank.v unionfind_iter.v env_unionfind_iter.v verif_summatrix.v spatial_graph_uf_iter.v verif_unionfind_iter.v verif_unionfind_iter_rank.v unionfind_arr.v env_unionfind_arr.v spatial_array_graph.v verif_unionfind_arr.v priq_utils.v priorityqueue.v dijkstra.v dijk_pq_arr_macros.v dijk_pq_arr_spec.v env_dijkstra_arr.v spatial_dijkstra_array_graph.v verif_priorityqueue.v verif_dijkstra.v verif_copy_bi.v binary_heap_model.v binary_heap_Zmodel.v binary_heap.v env_binary_heap.v verif_binary_heap.v binary_heap_pro.v env_binary_heap_pro.v verif_binary_heap_pro.v
...
KRUSKAL_FILES = \
  kruskal_edgelist.v env_kruskal_edgelist.v WeightedEdgeListGraph.v undirected_graph.v mst.v spatial_wedgearray_graph.v kruskal_uf_specs.v verif_kruskal_edgelist.v
