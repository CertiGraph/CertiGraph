...
-R CertiGraph           CertiGraph
-R ext/coq_ext          CertiGraph.lib
-R ext/msl_ext          CertiGraph.msl_ext
-R ext/floyd_ext        CertiGraph.floyd_ext
-R ext/veric_ext        CertiGraph.veric_ext
endef
export _COQ_PROJECT_HEADER

define _COQ_PROJECT_HEADER_EXAMPLES
-R examples/append      CertiGraph.append
-R examples/binheap     CertiGraph.binheap
-R examples/CertiGC     CertiGraph.CertiGC
-R examples/copy        CertiGraph.copy
-R examples/dijkstra    CertiGraph.dijkstra
-R examples/dispose     CertiGraph.dispose
-R examples/kruskal     CertiGraph.kruskal
-R examples/mark        CertiGraph.mark
-R examples/prim        CertiGraph.prim
-R examples/priq        CertiGraph.priq
-R examples/summatrix   CertiGraph.summatrix
-R examples/unionfind   CertiGraph.unionfind
endef
...
_CoqProject.lib:
	...
	@[ -z $(VST_DIR) ] || echo "-R $(VST_DIR) VST" >> $@
	@[ -z $(COMPCERT_DIR) ] || echo "-R $(COMPCERT_DIR) compcert" >> $@
	@echo "" >> $@
	@find ./ext -name "*.v" >> $@
