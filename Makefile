...
KRUSKAL_FILES = \
  kruskal_edgelist.v env_kruskal_edgelist.v WeightedEdgeListGraph.v undirected_graph.v mst.v spatial_wedgearray_graph.v verif_kruskal_edgelist.v
