...
Module Info.
  ...
  Definition source_file := "prim/prim1.c".
...
Definition f_check_symmetric_matrix := {|
  ...
  fn_params := ((_graph, (tptr (tptr tint))) :: (_size, tint) :: nil);
  fn_vars := nil;
                ...
                (Ssequence
                  ...
                  (Ssequence
                    (Sset _t'3
                      (Ederef
                        (Ebinop Oadd (Etempvar _graph (tptr (tptr tint)))
                          (Etempvar _j tint) (tptr (tptr tint))) (tptr tint)))
                    (Ssequence
                      (Sset _t'4
                        (Ederef
...
(Ssequence
  ...
  (Sloop
    (Ssequence
      (Sifthenelse (Ebinop Olt (Etempvar _i tint) (Etempvar _size tint) tint)
        Sskip
        Sbreak)
      (Ssequence
        (Sset _j (Econst_int (Int.repr 0) tint))
        (Sloop
          (Ssequence
            (Sifthenelse (Ebinop Olt (Etempvar _j tint) (Etempvar _size tint)
                           tint)
              Sskip
              Sbreak)
            (Ssequence
              ...
              (Sassign
                (Ederef
                  (Ebinop Oadd (Etempvar _t'1 (tptr tint)) (Etempvar _j tint)
...
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
      ...
      ((Ebinop Omul (Etempvar _size tint) (Esizeof tint tulong) tulong) ::
       nil))
      ...
      (Scall None
        (Evar _initialise_list (Tfunction
                                 (Tcons (tptr tint)
                                   (Tcons tint (Tcons tint Tnil))) tvoid
                                 cc_default))
        ((Etempvar _parent (tptr tint)) :: (Etempvar _size tint) ::
      ...
      (Ssequence
        (Ssequence
          (Scall (Some _t'2)
            ...
            ((Ebinop Omul (Etempvar _size tint) (Esizeof tint tulong) tulong) ::
             nil))
          (Sset _out (Etempvar _t'2 (tptr tvoid))))
        (Ssequence
          (Scall None
            (Evar _initialise_list (Tfunction
                                     (Tcons (tptr tint)
          ...
          (Ssequence
            (Sassign
              (Ederef
                (Ebinop Oadd (Etempvar _key (tptr tint)) (Etempvar _r tint)
                  ...
                  (Sloop
                    (Ssequence
                      ...
                      (Ssequence
                        (Sset _t'10
                          (Ederef
                            (Ebinop Oadd (Etempvar _key (tptr tint))
                        ...
                        (Scall None
                          (Evar _push (Tfunction
                                        ...
                                        cc_default))
                          ((Etempvar _v tint) :: (Etempvar _t'10 tint) ::
