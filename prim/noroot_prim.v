...
Definition _u : ident := 82%positive.
...
Definition f_prim := {|
  ...
  fn_temps := ((_pq, (tptr tint)) :: (_v, tint) :: (_u, tint) ::
               (_v__1, tint) :: (_t'3, tint) :: (_t'2, tint) ::
               (_t'1, (tptr tint)) :: (_t'9, tint) :: (_t'8, tint) ::
...
(_prim :: _initialise_list :: _initialise_matrix ::
 ...
 _init :: ___builtin_debug :: ___builtin_write32_reversed ::
