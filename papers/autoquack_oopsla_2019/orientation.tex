...
(ultimate parent) of a \li{Node x}.\hspace{0.5em}A node is a root when its parent
...
At first glance, \li{find} appears rather trivial since it only has about 5 lines
of code and a \li{Node} only has a single outgoing pointer.
