...
marking cyclic graphs. To briefly give intuition about the DAG-specific 
...
We elide discussions about \li{spanning} and DAG \li{mark} 
in the interest of space, but the verification code is available in our artifact.
