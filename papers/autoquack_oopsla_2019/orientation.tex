...
While \li{find} may appear straightforward --- it is about 5 lines
long, and a \li{Node} only has one outgoing pointer ---
the rather subtle nature of path compression and the
