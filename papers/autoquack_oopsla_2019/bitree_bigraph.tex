\begin{tikzpicture}[
  ...
  \node[gnode] (n0) {};
  \node[gnode] (n1) [below = of n0, xshift=-22pt] {};
  \node[gnode] (n2) [below = of n0, xshift=22pt] {};
  \node[gnode] (n3) [below = of n1, xshift=-11pt] {};
  \node[gnode] (n4) [below = of n1, xshift=11pt] {};
  \node[gnode] (n5) [below = of n2, xshift=-11pt] {};
  \node[gnode] (n6) [below = of n2, xshift=11pt] {};
  \node[gnode] (n7) [below = of n4, xshift=11pt] {};
  \draw[->] (n0) to (n1);
  \draw[->] (n0) to (n2);
  \draw[->] (n1) to (n3);
  \draw[->] (n1) to (n4);
  ...
  \node[gnode] (m1) [below = of m0, xshift=-22pt] {};
  \node[gnode] (m2) [below = of m0, xshift=22pt] {};
  \node[gnode] (m3) [below = of m1, xshift=-11pt] {};
  \node[gnode] (m4) [below = of m1, xshift=11pt] {};
  \node[gnode] (m5) [below = of m2, xshift=-11pt] {};
  \node[gnode] (m6) [below = of m2, xshift=11pt] {};
  \node[gnode] (m7) [below = of m4, xshift=11pt] {};
  \draw[->] (m0) to (m1);
  \draw[->] (m0) to (m2);
  \draw[->] (m1) to (m3);
  \draw[->] (m1) to (m4);
