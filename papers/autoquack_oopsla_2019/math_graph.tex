...
\note[fix numbering]{Figure~\ref{fig:graphs}} shows the
...
graph. In \note[fix numbering]{Figure \ref{fig:pregraph}}, valid vertices are in $V$ and 
...
\note[repeating previous para. cut?]{Our entire library of formal 
...
\note[now repeats. cut?]{As a first step, we can prove many general, reusable lemmas
