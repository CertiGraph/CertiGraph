...
Many tools {\color{red}[cite cite cite]} use the Direct Model to 
...
available in the Step-Indexed Model. That is to say, we do 
not rely on any of its bells and whistles.
