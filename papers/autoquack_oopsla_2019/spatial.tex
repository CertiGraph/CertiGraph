...
Many tools (e.g.\ Charge! \citep{bengtson:charge},
...
instantiate both our interfaces, showing that we steer clear of
specialized properties that are only available in the Step-Indexed
Model. That is to say, we do not rely on any of its bells and
whistles.
