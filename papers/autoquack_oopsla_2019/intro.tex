...
range of programs, and \emph{modular} in that they allow code
...
%decorated programs. 
We briefly review the six programs we have already verified to give a sense 
...
A version of the paper that features three additional appendices is available 
