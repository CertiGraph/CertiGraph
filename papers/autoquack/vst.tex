...
In Figure~\ref{fig:spanning} we show our brief proof script of spanning tree algorithm. We have also verified mark on dag and copy on graph. For the sake of space, we do not put those scripts here.
