...
Coq based, tactics \cite{bengtson:charge}, somewhat similar to Floyd?

Coq based, more automated \cite{chlipala:bedrock}, how does this compare?

Less automation, more complete, not in Coq \cite{jacobs:verifast}

More automation, not in Coq \cite{Beckert:2007,DistefanoP08,berdine:smallfoot}  how do these compare, esp. the first two?

Non separation logic tools, e.g. Chalice?
