...
\node[ent] (LF) [above left=1 and 1.2 of CL] {\small Logic Fact};
\node[ent] (RF) [above right=1 and 1.2 of CL] {\small Ramification Fact};
\node[ent] (BF) [above=1 of LF] {\small $\bigstar$ Fact};
\node[ent] (BR) [above=1 of RF] {\small $\bigstar$ Ramification};
\node[ent] (GF) [above=1 of BF] {\small Graph Fact};
\node[ent] (GR) [above=1 of BR] {\small Graph Ramification};
\node[ent] (SLF) [above=1 of SL] {\small Supplementary Logic Fact};
\node[ent] (SBF) [above=1 of SLF] {\small Supplementary $\bigstar$ Fact};
\node[ent] (SGF) [above=1 of SBF] {\small Supplementary Graph Fact};
...
\draw [->] (BR) to (GR);
\draw [->] (BR) to (SBF);
\node (legend1) [below right=0.2 and -0.8 of SM] {\small Dependence};
\coordinate[left=0.8 of legend1]  (l1);
\draw [->] (l1) to (legend1);
\node (legend2) [right=1 of legend1] {\small Instantialization};
