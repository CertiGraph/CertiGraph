...
101 & 100 \\
100 & 42 \\
\end{array} \textrm{Can we get a pretty picture here?}
\]
...
\textbf{is} true but is not easy to prove, relying on the constructions in \S\ref{sec:foldunfold} and the fact that $\mu_{\mathsf{T}}$ constructs the weakest fixpoint.  In contrast, $\graphkt(100,\hat{\gamma}) |- 100 |-> 42,100,0 * \top$ is very easy to prove. % via fold/unfold.
