...
Along the way we discover---and show how to fix---a rather surprising and tricky error in Hobor and Villard's presentation: 
neither the Knaster-Tarski CITE nor the Appel-McAllester CITE method for solving recursive fixpoints is suitable for defining 
