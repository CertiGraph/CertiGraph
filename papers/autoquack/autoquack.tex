...
Size of Coq mathgraph

Size of Coq spacegraph

Size of VST tactics:
Size of VST memory model:

Changes to HIP/SLEEK: approximately 2,500 lines of code across 51 files
Size of H/S memory model: 

Size of VST examples:

Size of H/S example: 71 lines (figure X), module type generated 30 lines, Coq 358
