...
\[
%\m{mark}(\gamma,x,\gamma') ~~ \stackrel{\Delta}{=} ~~
...
{\color{magenta} The reason why \infrulestyle{Frame} is so important is because it enables local verifications.  That is, rather than BLAH.}
