...
The middle tower is more interesting in that it is entirely focused on ramification entailments.  A robust library of ramification entailments is essential to making ramification work smoothly in practice.  The lowest level contains lemmas like:
\[
