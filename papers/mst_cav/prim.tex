 ...
 while Q $\neq$ $\emptyset$
  ...
  for each v in G.Adj[u]
   if v $\in$ Q and w(u,v) $<$ v.key
    v.parent = u
    v.key = w(u,v) $\hide{\label{code:primeditpri}}$
