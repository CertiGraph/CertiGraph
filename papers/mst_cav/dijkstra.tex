...
%An $\mathsf{Item}(\texttt{i},\m{(key, pri, data)})$
...
cheapest unoptimized vertex, as on line~\ref{code:pop}. Of course, the 
...
nonstandard \texttt{decrease\_pri} 
...
which supports this efficiently via a general \texttt{pq\_edit\_pri} operation.
