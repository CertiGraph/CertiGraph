...
We develop three variations of
adjacency-matrix representation (see~\S\ref{sec:newspatial}) and
we verify Dijkstra using each of them.
...
categories:
\begin{enumerate}
\item $\m{inv\_popped}$: $\m{dst}$ has been popped from the PQ
and fully processed.
