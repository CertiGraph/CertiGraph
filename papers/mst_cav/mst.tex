...
% functional
%\SetWatermarkText{\hspace*{5in}\raisebox{5.in}{\includegraphics[scale=0.8]{badges/aec-badge_f}}}

% available
% \SetWatermarkText{\hspace*{5in}\raisebox{5.in}{\includegraphics[scale=0.8]{badges/aec-badge_a}}}

% functional + available
% \SetWatermarkText{\hspace*{5in}\raisebox{5.in}{\includegraphics[scale=0.8]{badges/aec-badge_f_a}}}

% functional + reusable
% \SetWatermarkText{\hspace*{5in}\raisebox{5.in}{\includegraphics[scale=0.8]{badges/aec-badge_f_r}}}

% functional + available + reusable
\SetWatermarkText{\hspace*{5in}\raisebox{5.in}{\includegraphics[scale=0.8]{badges/aec-badge_f_a_r}}}
