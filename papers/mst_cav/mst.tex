...
% If there are more than two authors, 'et al.' is used.
	...
	\begin{abstract}
		\vspace{-1.2em}
		This paper provides proof-verified C graph implementations
		of Dijkstra's, Prim's and Kruskal's classical algorithms.
		We prove functional correctness of these implementations, and improve Wang et al\cite{DBLP:journals/pacmpl/WangCMH19}'s CertiGraph platform to reason about undirected graph properties and common spatial representations.
