...
\noindent Our results are completely machine-checked in Coq and available to reviewers~\cite{anonrepo}.%  Our code is available at \url{https://github.com/anshumanmohan/CertiGraph}.
