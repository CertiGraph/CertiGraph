...
%; when $\texttt{size}=1$ we further require that
...
Dijkstra's original paper~\cite{DBLP:journals/nm/Dijkstra59} ignores the issue, as do the standard textbooks \emph{Introduction to Algorithms} (\emph{a.k.a.} CLRS) by Cormen \emph{et al.}~\cite{clrs} and \emph{Algorithm Design} by Kleinberg and Tardos~\cite{DBLP:books/daglib/0015106}.
