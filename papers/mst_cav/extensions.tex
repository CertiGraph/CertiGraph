...
memory, but the third needs to allocate
...
the address of any array \m{i} from the base address of the graph.
...
to a tuple, and overload the \p{array} predicate to represent 
