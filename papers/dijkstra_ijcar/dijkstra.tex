...
Unlike previous work, we use classic textbook code written in CompCert C.
Our code is executable and realistic, meaning that our verification
needs to deal with real-world complications.
% We prove full functional correctness, and not just program safety.
In particular, we expose and discuss an overflow issue in 
