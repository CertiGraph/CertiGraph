...
\uncover<3->{\textbf{Contribution 6: three adjacency matrix representations}}
...
\uncover<2->{\textbf{Contribution 7: machine-certified ``real C'' Prim}}

\bigskip

\uncover<3->{\textbf{Contribution 8: more general specification}}

\bigskip

\uncover<4->{\textbf{Contribution 9: three adjacency matrix representations}}

\uncover<5->{(code bases differ by less than 1\%)}

\bigskip

\uncover<6->{\textbf{Contribution 10: novel Prim variant without root}}
