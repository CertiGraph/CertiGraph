...
\begin{frame}[fragile]{Overview of \texttt{forward (proposal)}}
  ...
  \begin{tikzpicture}[heap/.style={rectangle split, rectangle split parts=#1, draw,
    ...
    (gen 0) {\color{white}{\scriptsize 1}\nodepart{three}\color{white}{\scriptsize 2}};
    ...
    \draw[->] (gen 0.two west)..controls +(-1.2, 0.3) and +(-1.2, -0.3)..
    (gen 0.three split west);
    \draw<2->[->,dashed] (gen 0.one east)..controls +(1.5, 0) and +(-1.5, 0)..
    (gen 1.seven split west);
    \draw<2>[->,red] (gen 1.eight west)..controls +(-2, -0.25) and +(1, -0.25)..
    (gen 0.three split east);
    \draw<3->[->,dashed] (gen 0.three east)..controls +(1.5, 0) and +(-1.5, 0)..
    (gen 1.nine split west);
    \draw<3->[->] (gen 1.eight east)..controls +(1.2, 0.3) and +(1.2, -0.3)..
