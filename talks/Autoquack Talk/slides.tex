...
\date[\hspace{1ex}SCW/S-REPLS, \number\day/\number\month/\number\year\hspace*{-2ex}]{Surrey Concurrency Workshop and S-REPLS 12 \\ \today}
...
\begin{frame}{Separation between pure and spatial reasoning}
  \centering
  \includegraphics[height=0.9\textheight]{certigc_theorems.pdf}
\end{frame}
