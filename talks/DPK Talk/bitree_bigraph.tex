\begin{tikzpicture}[
  ...
  \node [left = of n6, xshift = 16pt] {$\m{w}$};
  \node[gnodecol] (n7) [below = of n4, xshift=11pt] {};
  \node [left = of n7, xshift = 16pt] {$\m{u}$};
  \draw[->] (n1) to (n0);
%  \draw[->] (n2) to (n0);
  \draw[->] (n3) to (n1);
  \draw[->] (n4) to (n1);
  ...
  \node [left = of m1, xshift = 16pt] {$\m{v}$};
  ...
  \node [left = of m6, xshift = 16pt] {$\m{w}$};
  \node[gnodecol] (m7) [below = of m4, xshift=11pt] {};
  \node [left = of m7, xshift = 16pt] {$\m{u}$};
  \draw[->] (m1) to (m0);
