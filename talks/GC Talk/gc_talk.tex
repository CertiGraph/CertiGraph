...
\colorlet{mymaroon}{myred!65!black}
...
\uncover<1->{Verify \alert{graph-manipulating} programs \uncover<2->{\alert{!!}}
\\ \hspace{1em}written in \alert{executable C} \uncover<3->{\alert{!!}}
\\ \hspace{2em}with \alert{machine-checked} correctness proofs \uncover<4->{\alert{!!}}}
\bigskip
\uncover<5->{\flushright{Ubiquitous in critical areas!}}
\end{frame}
...
\pause \alert{\\New problem: verify the garbage collector}
\end{frame}
...
\uncover<4>{\vspace{-6em}\hspace{5.5cm}\Huge $\cong$}
\end{frame}
...
\begin{frame}[fragile]{Overview of \texttt{forward} and \texttt{do\_scan}}
  ...
  \begin{tikzpicture}[heap/.style={rectangle split, rectangle split parts=#1, draw,
    ...
    \node<1> [heap=10, rectangle split part fill={mymaroon, mypink,
        mymaroon, mypink, mypink, mymaroon, mypink, white}]
    (gen 0) {\color{white}{\scriptsize a}\nodepart{three}\color{white}{\scriptsize b}\nodepart{six}\color{white}{\scriptsize c}};
    \node<2> [heap=10, rectangle split part fill={red, mypink,
        mymaroon, mypink, mypink, mymaroon, mypink, white}]
    (gen 0) {\color{white}{\scriptsize a}\nodepart{three}\color{white}{\scriptsize b}\nodepart{six}\color{white}{\scriptsize c}};
    \node<3> [heap=10, rectangle split part fill={red, mypink,
        red, mypink, mypink, mymaroon, mypink, white}]
    (gen 0) {\color{white}{\scriptsize a}\nodepart{three}\color{white}{\scriptsize b}\nodepart{six}\color{white}{\scriptsize c}};
    \node<4> [heap=10, rectangle split part fill={red, mypink,
        red, mypink, mypink, NavyBlue, mypink, white}]
    (gen 0) {\color{white}{\scriptsize a}\nodepart{three}\color{white}{\scriptsize b}\nodepart{six}\color{white}{\scriptsize c}};
    \node<5-> [heap=10, rectangle split part fill={white}] (gen 0) {};

    \node<1>[heap=13, right = of gen 0.north east, anchor=north west,
      rectangle split part fill={mymaroon, mypink, mymaroon,
    ...
    \node<2>[heap=13, right = of gen 0.north east, anchor=north west,
      rectangle split part fill={mymaroon, mypink, mymaroon,
        mypink, mypink, mypink, mymaroon, mypink, white}]
        (gen 1) {\color{white}{\scriptsize d}\nodepart{three}\color{white}{\scriptsize e}\nodepart{seven}\color{white}{\scriptsize a}};
    \node<3>[heap=13, right = of gen 0.north east, anchor=north west,
      rectangle split part fill={mymaroon, mypink, mymaroon,
        mypink, mypink, mypink, mymaroon, mypink, mymaroon, mypink, mypink,
        white}] (gen 1)
    ...
    \node<4>[heap=13, right = of gen 0.north east, anchor=north west,
      rectangle split part fill={mymaroon, mypink, mymaroon,
        ...
        white}]
        (gen 1) {\color{white}{\scriptsize d}\nodepart{three}\color{white}{\scriptsize e}\nodepart{seven}\color{white}{\scriptsize a}\nodepart{nine}\color{white}{\scriptsize b}};
    \node<5,7>[heap=13, right = of gen 0.north east, anchor=north west,
      rectangle split part fill={mymaroon, mypink, mymaroon,
        mypink, mypink, mypink, mymaroon, mypink, mymaroon, mypink, mypink,
        white}]
        (gen 1) {\color{white}{\scriptsize d}\nodepart{three}\color{white}{\scriptsize e}\nodepart{seven}\color{white}{\scriptsize a}\nodepart{nine}\color{white}{\scriptsize b}};
    \node<6>[heap=13, right = of gen 0.north east, anchor=north west,
      rectangle split part fill={NavyBlue, mypink, mymaroon,
        mypink, mypink, mypink, mymaroon, mypink, mymaroon, mypink, mypink,
        white}]
        (gen 1) {\color{white}{\scriptsize d}\nodepart{three}\color{white}{\scriptsize e}\nodepart{seven}\color{white}{\scriptsize a}\nodepart{nine}\color{white}{\scriptsize b}};

    \node<1-5,7> [heap=16, right = of gen 1.north east, anchor=north west,
      rectangle split part fill={mymaroon, mypink, mypink, mymaroon,
        mypink, mymaroon, mypink, mypink, white}]
    (gen 2) {\color{white}{\scriptsize f}\nodepart{four}\color{white}{\scriptsize g}\nodepart{six}\color{white}{\scriptsize h}};
        \node<6> [heap=16, right = of gen 1.north east, anchor=north west,
      rectangle split part fill={mymaroon, mypink, mypink, NavyBlue,
        mypink, mymaroon, mypink, mypink, white}]
    (gen 2) {\color{white}{\scriptsize f}\nodepart{four}\color{white}{\scriptsize g}\nodepart{six}\color{white}{\scriptsize h}};

    \node<1> [heap=4, left = of gen 0.north west, anchor=north east,
      rectangle split part fill={mymaroon, mypink, mypink, mypink}] (roots) {\color{white}\scriptsize roots\nodepart{two}{\scriptsize (1,1)}\nodepart{three}{\scriptsize (2,2)}\nodepart{four}{\scriptsize (3,1)}};
    ...
    \draw<2,3>[->,red] (gen 1.eight west)..controls +(-1.5, 0) and +(1, -0.25)..
...
\uncover<2->{\texttt{    forward} \checkmark}
\uncover<4->{\texttt{    do\_scan} \checkmark}
\uncover<5->{\texttt{    do\_gen} \checkmark}


\end{frame}
\colorlet{mymaroon}{stash}
\colorlet{red}{stash2}
...
\begin{frame}{Our Workflow}
  \begin{tikzpicture}[remember picture,overlay, on grid,
      ...
      cmd/.style={rectangle, fill=yellow!50!white, draw=black =4pt},
