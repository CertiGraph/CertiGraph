...
Module Info.
  ...
  Definition source_file := "verif/kruskal_edgelist.c"%string.
...
Definition _find : ident := 66%positive.
Definition _freeSet : ident := 69%positive.
Definition _free_graph : ident := 74%positive.
Definition _graph : ident := 11%positive.
Definition _graph__1 : ident := 70%positive.
Definition _i : ident := 76%positive.
Definition _init_graph_sample : ident := 71%positive.
Definition _init_mst : ident := 73%positive.
Definition _kruskal : ident := 79%positive.
Definition _main : ident := 80%positive.
Definition _makeSet : ident := 68%positive.
Definition _maybe_free : ident := 65%positive.
Definition _mst : ident := 72%positive.
Definition _parent : ident := 1%positive.
Definition _rank : ident := 2%positive.
Definition _subset : ident := 3%positive.
Definition _subsets : ident := 75%positive.
Definition _surely_malloc : ident := 64%positive.
Definition _u : ident := 4%positive.
Definition _ufind : ident := 77%positive.
Definition _v : ident := 5%positive.
Definition _vfind : ident := 78%positive.
Definition _weight : ident := 6%positive.
Definition _t'1 : ident := 81%positive.
Definition _t'10 : ident := 90%positive.
...
Definition _t'6 : ident := 86%positive.
Definition _t'7 : ident := 87%positive.
Definition _t'8 : ident := 88%positive.
Definition _t'9 : ident := 89%positive.
          ...
          (Ssequence
            (Sassign
              (Efield
                ...
                tint) (Econst_int (Int.repr 6) tint))
            (Ssequence
              (Sassign
                (Efield
                  (Ederef
...
Definition f_kruskal := {|
  ...
  fn_temps := ((_V, tint) :: (_subsets, (tptr (Tstruct _subset noattr))) ::
               ...
               (_t'1, (tptr (Tstruct _subset noattr))) :: (_t'10, tint) ::
               (_t'9, (tptr (Tstruct _edge noattr))) ::
               (_t'8, (tptr (Tstruct _edge noattr))) ::
    ...
    (Ssequence
                        ...
                        (Ssequence
                          ...
                          (Scall None
                            (Evar _Union (Tfunction
                                           ...
                                           tvoid cc_default))
                            ((Etempvar _subsets (tptr (Tstruct _subset noattr))) ::
                             (Etempvar _u tint) :: (Etempvar _v tint) :: nil))))
                      Sskip))))))
          (Sset _i
      ...
      (Scall None
        (Evar _freeSet (Tfunction
                         (Tcons (tptr (Tstruct _subset noattr)) Tnil) tvoid
                         cc_default))
...
Definition f_main := {|
  ...
  fn_temps := ((_graph__1, (tptr (Tstruct _graph noattr))) ::
               ...
               (_t'1, (tptr (Tstruct _graph noattr))) :: (_t'3, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
        (Evar _init_graph_sample (Tfunction Tnil
                                   (tptr (Tstruct _graph noattr)) cc_default))
        nil)
      (Sset _graph__1 (Etempvar _t'1 (tptr (Tstruct _graph noattr)))))
    (Ssequence
      (Ssequence
        (Ssequence
          (Sset _t'3
...
((___builtin_ais_annot,
 ...
 (_init_mst, Gfun(Internal f_init_mst)) ::
 (_free_graph, Gfun(Internal f_free_graph)) ::
 (_kruskal, Gfun(Internal f_kruskal)) :: (_main, Gfun(Internal f_main)) ::
 nil).

Definition public_idents : list ident :=
(_main :: _kruskal :: _free_graph :: _init_mst :: _init_graph_sample ::
 _freeSet :: _makeSet :: _Union :: _find :: _maybe_free :: _surely_malloc ::
