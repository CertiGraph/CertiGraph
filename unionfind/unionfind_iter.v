...
Module Info.
  ...
  Definition source_file := "sample_mark/unionfind_iter.c"%string.
...
Definition _find : ident := 58%positive.
...
Definition f_find := {|
  ...
  fn_body :=
(Ssequence
  (Sset _tmp (Etempvar _x (tptr (Tstruct _Node noattr))))
  (Ssequence
    (Sset _p
      (Efield
    ...
    (Ssequence
      (Swhile
        ...
        (Ssequence
          (Sset _tmp (Etempvar _p (tptr (Tstruct _Node noattr))))
          (Sset _p
            (Efield
              (Ederef (Etempvar _tmp (tptr (Tstruct _Node noattr)))
      ...
      (Ssequence
        (Swhile
          (Ebinop One (Etempvar _x (tptr (Tstruct _Node noattr)))
            (Etempvar _p (tptr (Tstruct _Node noattr))) tint)
          (Ssequence
            (Sset _tmp
              (Efield
            ...
            (Ssequence
              ...
              (Sset _x (Etempvar _tmp (tptr (Tstruct _Node noattr)))))))
...
((___builtin_bswap64,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_find, Gfun(Internal f_find)) :: nil).

Definition public_idents : list ident :=
(_find :: ___builtin_debug :: ___builtin_write32_reversed ::
