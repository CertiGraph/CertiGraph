...
#[export] Instance SAGA_VST: SpatialArrayGraphAssum mpred. Proof. refine (Build_SpatialArrayGraphAssum _ _ _ _ _). Defined.
...
#[export] Instance SAG_VST (sh: share): SpatialArrayGraph pointer_val mpred.
Proof.
(*       pointer_val         mpred *)
