...
#[export] Instance PointerValE_EqDec: EquivDec.EqDec (pointer_val * unit) eq.
  hnf; intros. destruct x, y.
  destruct u, u0. destruct (PV_eq_dec p p0); [left | right]; congruence.
Defined.

#[export] Instance SGBA_VST: PointwiseGraphBasicAssum pointer_val (pointer_val * unit).
...
Section sSGG_VST.
  ...
  #[export] Instance SGP_VST (sh: share) : PointwiseGraphPred addr (addr * unit) (nat * addr) unit mpred.
