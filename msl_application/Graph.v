...
Proof.
  intros.
  unfold vertices_identical0, vertices_identical, respectful_relation.
...
Proof.
  ...
  + intros.
    ...
    f_equal.
    destruct H.
    unfold vertices_identical, respectful_relation in H2.
...
Proof.
  ...
  f_equal.
  specialize (H1 c H2).
  unfold vertices_identical, respectful_relation in H1.
  rewrite guarded_pointwise_relation_spec in H1.
  apply H1; auto.
Qed.
...
Definition reachable_vertices_at_dag (x: V) (g: Graph): Pred := !! localDag g x && vertices_at (reachable g x) (Graph_SpatialGraph g).
...
Definition reachable_through_vertices_at_dag (S : list V) (g : Graph): Pred := !! (Forall (localDag g) S) && vertices_at (reachable_through_set g S) (Graph_SpatialGraph g).
