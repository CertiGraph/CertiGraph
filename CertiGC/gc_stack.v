...
Module Info.
  ...
  Definition source_file := "CertiGC/gc_stack.c".
...
Definition f_forward := {|
  ...
  fn_temps := ((_v, (tptr (talignas 3%N (tptr tvoid)))) ::
               ...
               (_i, tlong) :: (_sz, tlong) ::
               (_newv, (tptr (talignas 3%N (tptr tvoid)))) :: (_t'5, tint) ::
                    ...
                    (Ssequence
                      (Sassign
                        (Ederef
                          ...
                          (tptr (talignas 3%N (tptr tvoid))))
                        (Ebinop Oadd
                          (Etempvar _newv (tptr (talignas 3%N (tptr tvoid))))
                          (Etempvar _sz tlong)
                          (tptr (talignas 3%N (tptr tvoid)))))
                      (Ssequence
                        (Sassign
                ...
                (Ssequence
                  (Scall None
                    ...
                    ((Evar ___stringlit_4 (tarray tschar 30)) ::
                     ...
                     (Evar ___stringlit_2 (tarray tschar 49)) :: nil))
...
Definition f_forward_roots := {|
  ...
  fn_params := ((_from_start, (tptr (talignas 3%N (tptr tvoid)))) ::
                (_from_limit, (tptr (talignas 3%N (tptr tvoid)))) ::
                (_next, (tptr (tptr (talignas 3%N (tptr tvoid))))) ::
                (_frames, (tptr (Tstruct _stack_frame noattr))) :: nil);
  fn_vars := nil;
  fn_temps := ((_frame, (tptr (Tstruct _stack_frame noattr))) ::
               (_start, (tptr (talignas 3%N (tptr tvoid)))) ::
               (_i, tulong) :: (_limit, tulong) ::
               (_t'1, (tptr (talignas 3%N (tptr tvoid)))) :: nil);
  fn_body :=
(Ssequence
  (Sset _frame (Etempvar _frames (tptr (Tstruct _stack_frame noattr))))
  (Swhile
        ...
        (Ssequence
          (Sset _t'1
            (Efield
              ...
              (tptr (talignas 3%N (tptr tvoid)))))
          (Sset _limit
            (Ebinop Osub (Etempvar _t'1 (tptr (talignas 3%N (tptr tvoid))))
              (Etempvar _start (tptr (talignas 3%N (tptr tvoid)))) tlong)))
        (Ssequence
          (Sset _frame
            (Efield
              (Ederef (Etempvar _frame (tptr (Tstruct _stack_frame noattr)))
                ...
                (Scall None
                  ...
                  ((Etempvar _from_start (tptr (talignas 3%N (tptr tvoid)))) ::
                   ...
                   (Ebinop Oadd
                     ...
                     (Etempvar _i tulong) (tptr (talignas 3%N (tptr tvoid)))) ::
                   (Econst_int (Int.repr 0) tint) :: nil)))
              (Sset _i
...
Definition f_do_generation := {|
  ...
  fn_params := ((_from, (tptr (Tstruct _space noattr))) ::
                (_to, (tptr (Tstruct _space noattr))) ::
                (_fr, (tptr (Tstruct _stack_frame noattr))) :: nil);
  fn_vars := nil;
            ...
            ((Etempvar _t'5 (tptr (talignas 3%N (tptr tvoid)))) ::
             ...
             (Eaddrof
               (Efield
                 ...
                 (tptr (talignas 3%N (tptr tvoid))))
               (tptr (tptr (talignas 3%N (tptr tvoid))))) ::
             (Etempvar _fr (tptr (Tstruct _stack_frame noattr))) :: nil))))
      (Ssequence
        (Ssequence
          (Sset _t'3
            (Efield
      ...
      (Scall None
        ...
        ((Ebinop Oadd
           (Efield
             ...
             (tarray (Tstruct _space noattr) 43))
        ...
        (Ssequence
          (Scall None
            ...
            ((Evar ___stringlit_4 (tarray tschar 30)) ::
             ...
             (Evar ___stringlit_8 (tarray tschar 2)) :: nil))
...
Definition f_garbage_collect := {|
  ...
  fn_temps := ((_h, (tptr (Tstruct _heap noattr))) :: (_i, tint) ::
               (_w, tlong) :: (_t'10, (tptr (talignas 3%N (tptr tvoid)))) ::
  ...
  (Ssequence
    ...
    (Scall None
      ...
      ((Etempvar _t'2 (tptr (Tstruct ___sFILE noattr))) ::
       (Evar ___stringlit_11 (tarray tschar 22)) :: nil)))
  (Ssequence
    (Sset _i (Econst_int (Int.repr 0) tint))
    (Sloop
      (Ssequence
              ...
              (Ederef
                (Ebinop Oadd
                  (Efield
                    (Ederef (Etempvar _h (tptr (Tstruct _heap noattr)))
                      (Tstruct _heap noattr)) _spaces
                    (tarray (Tstruct _space noattr) 43)) (Etempvar _i tint)
                  (tptr (Tstruct _space noattr))) (Tstruct _space noattr))
              _start (tptr (talignas 3%N (tptr tvoid)))))
          (Sassign
            (Efield
  ...
  (Ssequence
    ...
    (Scall None
      (Evar _fprintf (Tfunction
                       ...
                       {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|}))
      ((Etempvar _t'1 (tptr (Tstruct ___sFILE noattr))) ::
       (Evar ___stringlit_12 (tarray tschar 21)) :: nil)))
  (Ssequence
    (Ssequence
      (Sset _i (Econst_int (Int.repr 0) tint))
      (Sloop
...
Definition f_export_heap := {|
  ...
  fn_temps := ((_gen_level, tint) :: (_sp, (tptr (Tstruct _space noattr))) ::
               ...
               (_t'13, (tptr (Tstruct _heap noattr))) ::
               (_t'12, (tptr (talignas 3%N (tptr tvoid)))) ::
               (_t'11, (tptr (talignas 3%N (tptr tvoid)))) ::
               (_t'10, (tptr (Tstruct _stack_frame noattr))) ::
               (_t'9, (tptr (talignas 3%N (tptr tvoid)))) ::
               (_t'8, (tptr (talignas 3%N (tptr tvoid)))) ::
                ...
                (Ssequence
                  ...
                  (Sset _sp
                    (Ebinop Oadd
                      (Efield
                        (Ederef
                          (Etempvar _t'13 (tptr (Tstruct _heap noattr)))
                          (Tstruct _heap noattr)) _spaces
                        (tarray (Tstruct _space noattr) 43))
                    ...
                    (Ssequence
                      (Ssequence
                        ...
                        (Scall None
                          ...
                          ((Etempvar _sp (tptr (Tstruct _space noattr))) ::
                           (Etempvar _fake_sp (tptr (Tstruct _space noattr))) ::
                           (Etempvar _t'10 (tptr (Tstruct _stack_frame noattr))) ::
                           nil)))
                      (Ssequence
                        (Ssequence
                          (Scall (Some _t'4)
      ...
      (Sifthenelse (Ebinop Olt
        ...
        (Ssequence
          (Scall None
            ...
            ((Evar ___stringlit_4 (tarray tschar 30)) ::
             (Evar ___stringlit_3 (tarray tschar 11)) ::
             (Econst_int (Int.repr 523) tint) ::
             (Evar ___stringlit_13 (tarray tschar 22)) :: nil))
          (Scall None (Evar _abort (Tfunction Tnil tvoid cc_default)) nil)))))
  (Ssequence
    (Sassign
    ...
    (Ssequence
      (Scall (Some _t'2)
        (Evar _is_ptr (Tfunction (Tcons (talignas 3%N (tptr tvoid)) Tnil)
                        tint cc_default))
          ...
          (Ssequence
            ...
            (Ssequence
              (Scall None
                (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                                {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                ((Evar ___stringlit_14 (tarray tschar 16)) ::
              ...
              (Ssequence
                      ...
                      (Ssequence
                        ...
                        (Scall None
                          (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil)
                                          tint
                                          {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                          ((Evar ___stringlit_15 (tarray tschar 12)) ::
                           (Ecast
                             (Ebinop Osub
                               (Etempvar _t'3 (tptr (talignas 3%N (tptr tvoid))))
                               (Etempvar _t'5 (tptr (talignas 3%N (tptr tvoid))))
                ...
                (Ssequence
                  ...
                  (Scall None
                    (Evar _printf (Tfunction (Tcons (tptr tschar) Tnil) tint
                                    {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|}))
                    ((Evar ___stringlit_17 (tarray tschar 18)) ::
...
((___compcert_va_int32,
 ...
 (_is_ptr, Gfun(Internal f_is_ptr)) ::
 ...
 (_export_heap, Gfun(Internal f_export_heap)) ::
 (_certicoq_modify, Gfun(Internal f_certicoq_modify)) ::
 (_print_heapsize, Gfun(Internal f_print_heapsize)) :: nil).

Definition public_idents : list ident :=
(_print_heapsize :: _certicoq_modify :: _export_heap ::
 _garbage_collect_all :: _free_heap :: _reset_heap :: _garbage_collect ::
 _resume :: _make_tinfo :: _create_heap :: _create_space :: _do_generation ::
 _do_scan :: _forward_roots :: _forward_remset :: _forward :: _Is_from ::
 _abort_with :: _is_ptr :: _ptr_to_int_or_ptr :: _int_to_int_or_ptr ::
