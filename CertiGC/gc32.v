...
Definition v___stringlit_2 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 67) :: Init_int8 (Int.repr 101) ::
                Init_int8 (Int.repr 114) :: Init_int8 (Int.repr 116) ::
                Init_int8 (Int.repr 105) :: Init_int8 (Int.repr 71) ::
                ...
                (Sifthenelse (Ebinop Olt (Etempvar _t'2 tuint)
                  ...
                  (Scall None
                    (Evar ___assert_func (Tfunction
                                           ...
                                           tvoid cc_default))
                    ((Evar ___stringlit_2 (tarray tschar 13)) ::
...
Definition f_do_generation := {|
  ...
  fn_temps := ((_p, (tptr (talignas 2%N (tptr tvoid)))) ::
               ...
               (_t'3, (tptr (Tstruct ___sFILE64 noattr))) ::
                      ...
                      (Scall None
                        (Evar _fprintf (Tfunction
                                         (Tcons
                                           ...
                                           (Tcons (tptr tschar) Tnil)) tint
                                         {|cc_vararg:=(Some 2); cc_unproto:=false; cc_structret:=false|}))
                        ((Etempvar _t'3 (tptr (Tstruct ___sFILE64 noattr))) ::
...
Definition f_garbage_collect := {|
  ...
  fn_temps := ((_h, (tptr (Tstruct _heap noattr))) :: (_i, tint) ::
               (_w, tint) :: (_t'1, (tptr (Tstruct __reent noattr))) ::
               (_t'10, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'9, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'8, (tptr (talignas 2%N (tptr tvoid)))) ::
               (_t'7, (tptr (talignas 2%N (tptr tvoid)))) ::
                  ...
                  (Ssequence
                    ...
                    (Ssequence
                      (Sset _t'6
                        (Efield
                          (Ederef
                            (Etempvar _t'1 (tptr (Tstruct __reent noattr)))
                            (Tstruct __reent noattr)) __stderr
                          (tptr (Tstruct ___sFILE64 noattr))))
                      (Scall None
                        (Evar _fprintf (Tfunction
      ...
      (Ssequence
        ...
        (Scall None
          ...
          ((Evar ___stringlit_2 (tarray tschar 13)) ::
           ...
           (Ecast (Econst_int (Int.repr 0) tint) (tptr tvoid)) ::
           (Evar ___stringlit_13 (tarray tschar 2)) :: nil))))))
|}.
...
Definition f_reset_heap := {|
  ...
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (_t'1, (tptr (Tstruct __reent noattr))) ::
               (_t'3, (tptr (Tstruct ___sFILE64 noattr))) ::
               (_t'2, (tptr (talignas 2%N (tptr tvoid)))) :: nil);
  fn_body :=
(Ssequence
...
(Composite __140 Union
 ...
 Composite _thread_info Struct
   (Member_plain _alloc (tptr (talignas 2%N (tptr tvoid))) ::
    Member_plain _limit (tptr (talignas 2%N (tptr tvoid))) ::
    Member_plain _heap (tptr (Tstruct _heap noattr)) ::
    Member_plain _args (tarray (talignas 2%N (tptr tvoid)) 1024) :: nil)
   noattr ::
 Composite _space Struct
   (Member_plain _start (tptr (talignas 2%N (tptr tvoid))) ::
    Member_plain _next (tptr (talignas 2%N (tptr tvoid))) ::
    Member_plain _limit (tptr (talignas 2%N (tptr tvoid))) :: nil)
   noattr ::
...
((___compcert_va_int32,
 ...
 (___compcert_i64_umulh,
   Gfun(External (EF_runtime "__compcert_i64_umulh"
                   (mksignature (AST.Tlong :: AST.Tlong :: nil) AST.Tlong
                     cc_default)) (Tcons tulong (Tcons tulong Tnil)) tulong
     cc_default)) :: (___stringlit_15, Gvar v___stringlit_15) ::
...
(_free_heap :: _reset_heap :: _garbage_collect :: _resume :: _make_tinfo ::
 ...
 _free :: _malloc :: ___assert_func :: _fprintf :: ___getreent ::
