...
Definition ___stringlit_11 : ident := 146%positive.
...
Definition ___stringlit_7 : ident := 134%positive.
Definition ___stringlit_8 : ident := 137%positive.
Definition ___stringlit_9 : ident := 142%positive.
...
Definition _create_heap : ident := 135%positive.
Definition _create_space : ident := 132%positive.
...
Definition _lo : ident := 139%positive.
Definition _main : ident := 155%positive.
Definition _make_tinfo : ident := 138%positive.
...
Definition _num_allocs : ident := 141%positive.
...
Definition _resume : ident := 144%positive.
...
Definition v___stringlit_11 := {|
  ...
  gvar_init := (Init_int8 (Int.repr 104) :: Init_int8 (Int.repr 45) ::
                Init_int8 (Int.repr 62) :: Init_int8 (Int.repr 115) ::
                Init_int8 (Int.repr 112) :: Init_int8 (Int.repr 97) ::
                Init_int8 (Int.repr 99) :: Init_int8 (Int.repr 101) ::
                Init_int8 (Int.repr 115) :: Init_int8 (Int.repr 91) ::
                Init_int8 (Int.repr 48) :: Init_int8 (Int.repr 93) ::
                Init_int8 (Int.repr 46) :: Init_int8 (Int.repr 108) ::
...
Definition f_test_int_or_ptr := {|
  ...
  fn_body :=
(Sreturn (Some (Ecast
                 (Ebinop Oand (Ecast (Etempvar _x (tptr tvoid)) tint)
...
Definition f_int_or_ptr_to_int := {|
  ...
  fn_temps := nil;
  fn_body :=
(Sreturn (Some (Ecast (Etempvar _x (tptr tvoid)) tint)))
|}.
...
Definition f_int_to_int_or_ptr := {|
  ...
  fn_temps := nil;
  fn_body :=
(Sreturn (Some (Ecast (Etempvar _x tint) (tptr tvoid))))
|}.
...
Definition f_Is_from := {|
  fn_return := tint;
  fn_callconv := cc_default;
  fn_params := ((_from_start, (tptr (tptr tvoid))) ::
                (_from_limit, (tptr (tptr tvoid))) ::
                (_v, (tptr (tptr tvoid))) :: nil);
  fn_vars := nil;
  fn_temps := ((_t'1, tint) :: nil);
  fn_body :=
(Ssequence
  (Sifthenelse (Ebinop Ole (Etempvar _from_start (tptr (tptr tvoid)))
                 (Etempvar _v (tptr (tptr tvoid))) tint)
    (Sset _t'1
      (Ecast
        (Ebinop Olt (Etempvar _v (tptr (tptr tvoid)))
          (Etempvar _from_limit (tptr (tptr tvoid))) tint) tbool))
...
Definition f_forward := {|
  ...
  fn_params := ((_from_start, (tptr (tptr tvoid))) ::
                (_from_limit, (tptr (tptr tvoid))) ::
                (_next, (tptr (tptr (tptr tvoid)))) ::
                (_p, (tptr (tptr tvoid))) :: (_depth, tint) :: nil);
  fn_vars := nil;
  fn_temps := ((_v, (tptr (tptr tvoid))) :: (_va, (tptr tvoid)) ::
               (_hd, tuint) :: (_i, tint) :: (_sz, tint) ::
               (_new, (tptr (tptr tvoid))) :: (_t'5, tint) :: (_t'4, tint) ::
               (_t'3, (tptr tvoid)) :: (_t'2, (tptr tvoid)) ::
               (_t'1, (tptr tvoid)) :: nil);
  fn_body :=
(Ssequence
  (Sset _va (Ederef (Etempvar _p (tptr (tptr tvoid))) (tptr tvoid)))
  (Ssequence
    (Scall (Some _t'5)
      (Evar _Is_block (Tfunction (Tcons (tptr tvoid) Tnil) tint cc_default))
      ((Etempvar _va (tptr tvoid)) :: nil))
      ...
      (Ssequence
        (Ssequence
          (Scall (Some _t'1)
            ...
            ((Etempvar _va (tptr tvoid)) :: nil))
          (Sset _v (Ecast (Etempvar _t'1 (tptr tvoid)) (tptr (tptr tvoid)))))
        (Ssequence
          (Scall (Some _t'4)
            (Evar _Is_from (Tfunction
                             ...
                             cc_default))
            ((Etempvar _from_start (tptr (tptr tvoid))) ::
             (Etempvar _from_limit (tptr (tptr tvoid))) ::
             (Etempvar _v (tptr (tptr tvoid))) :: nil))
          (Sifthenelse (Etempvar _t'4 tint)
            (Ssequence
              (Sset _hd
                (Ederef
                  (Ebinop Oadd
                    (Ecast (Etempvar _v (tptr (tptr tvoid))) (tptr tuint))
                    (Eunop Oneg (Econst_int (Int.repr 1) tint) tint)
                    (tptr tuint)) tuint))
              (Sifthenelse (Ebinop Oeq (Etempvar _hd tuint)
                             (Econst_int (Int.repr 0) tint) tint)
                (Sassign
                  (Ederef (Etempvar _p (tptr (tptr tvoid))) (tptr tvoid))
                  (Ederef
                    (Ebinop Oadd (Etempvar _v (tptr (tptr tvoid)))
                ...
                (Ssequence
                  ...
                  (Ssequence
                    (Sset _new
                      (Ebinop Oadd
                        (Ederef (Etempvar _next (tptr (tptr (tptr tvoid))))
                    ...
                    (Ssequence
                      (Sassign
                        (Ederef (Etempvar _next (tptr (tptr (tptr tvoid))))
                          (tptr (tptr tvoid)))
                        (Ebinop Oadd (Etempvar _new (tptr (tptr tvoid)))
                          (Etempvar _sz tint) (tptr (tptr tvoid))))
                      (Ssequence
                        (Ssequence
                          (Sset _i
                            (Eunop Oneg (Econst_int (Int.repr 1) tint) tint))
                          (Sloop
                            (Ssequence
                              ...
                              (Sassign
                                (Ederef
                                  (Ebinop Oadd
                                    (Etempvar _new (tptr (tptr tvoid)))
                                    (Etempvar _i tint) (tptr (tptr tvoid)))
                                  (tptr tvoid))
                                (Ederef
                                  (Ebinop Oadd
                        ...
                        (Ssequence
                          (Sassign
                            (Ederef
                              (Ebinop Oadd
                                (Ecast (Etempvar _v (tptr (tptr tvoid)))
                                  (tptr tuint))
                            ...
                            (Ssequence
                              (Scall (Some _t'2)
                                (Evar _ptr_to_int_or_ptr (Tfunction
                                                           ...
                                                           (tptr tvoid)
                                                           cc_default))
                                ((Ecast (Etempvar _new (tptr (tptr tvoid)))
                                   (tptr tvoid)) :: nil))
                              (Sassign
                                (Ederef
                                  (Ebinop Oadd
                              ...
                              (Ssequence
                                (Scall (Some _t'3)
                                  ...
                                  ((Ecast (Etempvar _new (tptr (tptr tvoid)))
                                     (tptr tvoid)) :: nil))
                                (Sassign
                                  (Ederef (Etempvar _p (tptr (tptr tvoid)))
                                    (tptr tvoid))
                                  ...
                                  (Sloop
                                    (Ssequence
                                      ...
                                      (Scall None
                                        ...
                                        ((Etempvar _from_start (tptr (tptr tvoid))) ::
                                         (Etempvar _from_limit (tptr (tptr tvoid))) ::
                                         (Etempvar _next (tptr (tptr (tptr tvoid)))) ::
                                         (Ebinop Oadd
                                           (Etempvar _new (tptr (tptr tvoid)))
                                           (Etempvar _i tint)
                                           (tptr (tptr tvoid))) ::
...
Definition f_forward_roots := {|
  ...
  fn_params := ((_from_start, (tptr (tptr tvoid))) ::
                (_from_limit, (tptr (tptr tvoid))) ::
                (_next, (tptr (tptr (tptr tvoid)))) :: (_fi, (tptr tuint)) ::
                (_ti, (tptr (Tstruct _thread_info noattr))) :: nil);
  fn_vars := nil;
  fn_temps := ((_args, (tptr (tptr tvoid))) :: (_n, tint) :: (_i, tuint) ::
               (_roots, (tptr tuint)) :: (_t'3, tvoid) :: (_t'2, tint) ::
               (_t'1, tvoid) :: nil);
  fn_body :=
(Ssequence
  (Sset _roots
      ...
      (Sset _args
        (Efield
          (Ederef (Etempvar _ti (tptr (Tstruct _thread_info noattr)))
            (Tstruct _thread_info noattr)) _args (tarray (tptr tvoid) 1024)))
      (Ssequence
        (Sset _i (Econst_int (Int.repr 0) tint))
        (Sloop
          (Ssequence
            ...
            (Ssequence
              ...
              (Scall None
                ...
                ((Etempvar _from_start (tptr (tptr tvoid))) ::
                 (Etempvar _from_limit (tptr (tptr tvoid))) ::
                 (Etempvar _next (tptr (tptr (tptr tvoid)))) ::
                 (Ebinop Oadd (Etempvar _args (tptr (tptr tvoid)))
                   (Ederef
                     (Ebinop Oadd (Etempvar _roots (tptr tuint))
                       (Etempvar _i tuint) (tptr tuint)) tuint)
                   (tptr (tptr tvoid))) :: (Econst_int (Int.repr 0) tint) ::
                 nil))))
          (Sset _i
...
Definition f_do_scan := {|
  ...
  fn_params := ((_from_start, (tptr (tptr tvoid))) ::
                (_from_limit, (tptr (tptr tvoid))) ::
                (_scan, (tptr (tptr tvoid))) ::
                (_next, (tptr (tptr (tptr tvoid)))) :: nil);
  fn_vars := nil;
  fn_temps := ((_s, (tptr (tptr tvoid))) :: (_hd, tuint) :: (_sz, tuint) ::
               (_tag, tint) :: (_j, tint) :: (_t'1, tint) :: nil);
  fn_body :=
(Ssequence
  (Sset _s (Etempvar _scan (tptr (tptr tvoid))))
  (Swhile
    (Ebinop Olt (Etempvar _s (tptr (tptr tvoid)))
      (Ederef (Etempvar _next (tptr (tptr (tptr tvoid))))
        (tptr (tptr tvoid))) tint)
    (Ssequence
      (Ssequence
        (Scall (Some _t'1)
          (Evar _int_or_ptr_to_int (Tfunction (Tcons (tptr tvoid) Tnil) tint
                                     cc_default))
          ((Ederef (Etempvar _s (tptr (tptr tvoid))) (tptr tvoid)) :: nil))
                    ...
                    (Scall None
                      ...
                      ((Etempvar _from_start (tptr (tptr tvoid))) ::
                       ...
                       (Ebinop Oadd (Etempvar _s (tptr (tptr tvoid)))
                         (Etempvar _j tint) (tptr (tptr tvoid))) ::
            ...
            (Sset _s
              (Ebinop Oadd (Etempvar _s (tptr (tptr tvoid)))
                (Ebinop Oadd (Econst_int (Int.repr 1) tint)
                  (Etempvar _sz tuint) tuint) (tptr (tptr tvoid))))))))))
|}.
...
Definition f_do_generation := {|
  ...
  fn_params := ((_from, (tptr (Tstruct _space noattr))) ::
                ...
                (_ti, (tptr (Tstruct _thread_info noattr))) :: nil);
  fn_vars := nil;
  fn_temps := ((_p, (tptr (tptr tvoid))) :: (_t'3, tvoid) :: (_t'2, tint) ::
               (_t'1, tvoid) :: nil);
  fn_body :=
(Ssequence
  (Sset _p
    (Efield
      (Ederef (Etempvar _to (tptr (Tstruct _space noattr)))
        (Tstruct _space noattr)) _next (tptr (tptr tvoid))))
  (Ssequence
    (Sifthenelse (Ebinop Ole
                   (Ebinop Osub
                     ...
                     (Efield
                       (Ederef
                         (Etempvar _from (tptr (Tstruct _space noattr)))
                         (Tstruct _space noattr)) _start (tptr (tptr tvoid)))
                     tint)
                   (Ebinop Osub
                     (Efield
                       (Ederef (Etempvar _to (tptr (Tstruct _space noattr)))
                         (Tstruct _space noattr)) _limit (tptr (tptr tvoid)))
                     (Efield
                       (Ederef (Etempvar _to (tptr (Tstruct _space noattr)))
                         (Tstruct _space noattr)) _next (tptr (tptr tvoid)))
                     tint) tint)
      (Sset _t'1 (Ecast (Ecast (Econst_int (Int.repr 0) tint) tvoid) tvoid))
      (Ssequence
        (Ssequence
          (Scall (Some _t'2)
          ...
          (Scall (Some _t'3) (Evar _abort (Tfunction Tnil tvoid cc_default))
            nil))
        (Sset _t'1 (Ecast (Etempvar _t'3 tvoid) tvoid))))
    (Ssequence
      (Scall None
        ...
        ((Efield
         ...
         (Eaddrof
           (Efield
             (Ederef (Etempvar _to (tptr (Tstruct _space noattr)))
               (Tstruct _space noattr)) _next (tptr (tptr tvoid)))
           (tptr (tptr (tptr tvoid)))) :: (Etempvar _fi (tptr tuint)) ::
        ...
        (Scall None
          (Evar _do_scan (Tfunction
                           (Tcons (tptr (tptr tvoid))
                             (Tcons (tptr (tptr tvoid))
                               (Tcons (tptr (tptr tvoid))
                                 (Tcons (tptr (tptr (tptr tvoid))) Tnil))))
                           tvoid cc_default))
          ((Efield
             (Ederef (Etempvar _from (tptr (Tstruct _space noattr)))
               (Tstruct _space noattr)) _start (tptr (tptr tvoid))) ::
           (Efield
             (Ederef (Etempvar _from (tptr (Tstruct _space noattr)))
               (Tstruct _space noattr)) _limit (tptr (tptr tvoid))) ::
           (Etempvar _p (tptr (tptr tvoid))) ::
           (Eaddrof
             (Efield
               (Ederef (Etempvar _to (tptr (Tstruct _space noattr)))
                 (Tstruct _space noattr)) _next (tptr (tptr tvoid)))
             (tptr (tptr (tptr tvoid)))) :: nil))
        (Ssequence
               ...
               (Ebinop Odiv
                 (Ebinop Osub
                   (Efield
                     (Ederef (Etempvar _to (tptr (Tstruct _space noattr)))
                       (Tstruct _space noattr)) _next (tptr (tptr tvoid)))
                   (Etempvar _p (tptr (tptr tvoid))) tint)
                 (Ecast
                   (Ebinop Osub
                     (Efield
                       (Ederef
...
Definition f_create_space := {|
  ...
  fn_vars := nil;
  fn_temps := ((_p, (tptr (tptr tvoid))) :: (_t'1, (tptr tvoid)) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
      (Evar _malloc (Tfunction (Tcons tuint Tnil) (tptr tvoid) cc_default))
      ((Ebinop Omul (Etempvar _n tuint) (Esizeof (tptr tvoid) tuint) tuint) ::
       nil))
    (Sset _p (Ecast (Etempvar _t'1 (tptr tvoid)) (tptr (tptr tvoid)))))
  (Ssequence
    (Sifthenelse (Ebinop Oeq (Etempvar _p (tptr (tptr tvoid)))
      ...
      (Ssequence
        ...
        (Sassign
          (Efield
            (Ederef (Etempvar _s (tptr (Tstruct _space noattr)))
              (Tstruct _space noattr)) _limit (tptr (tptr tvoid)))
          (Ebinop Oadd (Etempvar _p (tptr (tptr tvoid))) (Etempvar _n tuint)
            (tptr (tptr tvoid))))))))
|}.
      ...
      (Ssequence
        ...
        (Ssequence
          (Sassign
            (Efield
              (Ederef (Etempvar _tinfo (tptr (Tstruct _thread_info noattr)))
                (Tstruct _thread_info noattr)) _alloc (tptr (tptr tvoid)))
            (Efield
              (Ederef
                (Ebinop Oadd
                  (Efield
              ...
              _start (tptr (tptr tvoid))))
          (Ssequence
            (Sassign
              (Efield
                (Ederef
                  (Etempvar _tinfo (tptr (Tstruct _thread_info noattr)))
                  (Tstruct _thread_info noattr)) _limit (tptr (tptr tvoid)))
              (Efield
                (Ederef
                  (Ebinop Oadd
                    (Efield
...
Definition f_resume := {|
  ...
  fn_vars := nil;
  fn_temps := ((_h, (tptr (Tstruct _heap noattr))) ::
               (_lo, (tptr (tptr tvoid))) :: (_hi, (tptr (tptr tvoid))) ::
               (_num_allocs, tuint) :: (_t'3, tvoid) :: (_t'2, tint) ::
               (_t'1, tvoid) :: nil);
  fn_body :=
(Ssequence
  (Sset _h
          ...
          (Ssequence
            (Scall (Some _t'2)
              ...
              ((Evar ___stringlit_3 (tarray tschar 30)) ::
               ...
               (Evar ___stringlit_9 (tarray tschar 2)) :: nil))
            (Scall (Some _t'3)
              (Evar _abort (Tfunction Tnil tvoid cc_default)) nil))
          (Sset _t'1 (Ecast (Etempvar _t'3 tvoid) tvoid))))
      (Ssequence
        ...
        (Ssequence
          ...
          (Ssequence
            (Sifthenelse (Ebinop Olt
                           (Ebinop Osub (Etempvar _hi (tptr (tptr tvoid)))
                             (Etempvar _lo (tptr (tptr tvoid))) tint)
            ...
            (Ssequence
              (Sassign
                (Efield
                  ...
                  (tptr (tptr tvoid))) (Etempvar _lo (tptr (tptr tvoid))))
              (Sassign
                (Efield
                  (Ederef (Etempvar _ti (tptr (Tstruct _thread_info noattr)))
                    (Tstruct _thread_info noattr)) _limit
                  (tptr (tptr tvoid))) (Etempvar _hi (tptr (tptr tvoid)))))))))))
|}.
...
Definition f_garbage_collect := {|
  ...
  fn_temps := ((_h, (tptr (Tstruct _heap noattr))) :: (_i, tint) ::
               (_w, tint) :: (_t'7, tvoid) :: (_t'6, tint) ::
               (_t'5, tvoid) :: (_t'4, tvoid) :: (_t'3, tint) ::
               (_t'2, tvoid) :: (_t'1, (tptr (Tstruct _heap noattr))) :: nil);
  fn_body :=
(Ssequence
  (Sset _h
    (Efield
  ...
  (Ssequence
            ...
            (Ssequence
              (Scall (Some _t'3)
                ...
                ((Evar ___stringlit_3 (tarray tschar 30)) ::
                 ...
                 (Evar ___stringlit_11 (tarray tschar 32)) :: nil))
              (Scall (Some _t'4)
                (Evar _abort (Tfunction Tnil tvoid cc_default)) nil))
    ...
    (Ssequence
      (Ssequence
        ...
        (Scall (Some _t'7) (Evar _abort (Tfunction Tnil tvoid cc_default))
          nil))
      (Sset _t'5 (Ecast (Etempvar _t'7 tvoid) tvoid)))))
|}.
...
Definition f_free_heap := {|
  ...
  fn_params := ((_h, (tptr (Tstruct _heap noattr))) :: nil);
  fn_vars := nil;
  fn_temps := ((_i, tint) :: (_p, (tptr (tptr tvoid))) :: nil);
  fn_body :=
(Ssequence
  (Scall None
    (Evar _fprintf (Tfunction
              ...
              (Efield
                (Ederef
                  (Ebinop Oadd
                    ...
                    (tptr (Tstruct _space noattr))) (Tstruct _space noattr))
                _start (tptr (tptr tvoid))))
            (Sifthenelse (Ebinop One (Etempvar _p (tptr (tptr tvoid)))
                           (Ecast (Econst_int (Int.repr 0) tint)
                             (tptr tvoid)) tint)
              (Scall None
                (Evar _free (Tfunction (Tcons (tptr tvoid) Tnil) tvoid
                              cc_default))
                ((Etempvar _p (tptr (tptr tvoid))) :: nil))
              Sskip)))
        (Sset _i
          (Ebinop Oadd (Etempvar _i tint) (Econst_int (Int.repr 1) tint)
            tint))))
...
(Composite ___sbuf Struct
 ...
 Composite _thread_info Struct
   ((_alloc, (tptr (tptr tvoid))) :: (_limit, (tptr (tptr tvoid))) ::
    (_heap, (tptr (Tstruct _heap noattr))) ::
    (_args, (tarray (tptr tvoid) 1024)) :: nil)
   noattr ::
 Composite _space Struct
   ((_start, (tptr (tptr tvoid))) :: (_next, (tptr (tptr tvoid))) ::
    (_limit, (tptr (tptr tvoid))) :: nil)
   noattr ::
