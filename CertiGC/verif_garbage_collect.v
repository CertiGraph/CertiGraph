...
Proof.
  ...
  - Exists g roots t_info. destruct H1 as [? [? [? ?]]].
    destruct H0 as [? [? [? [? ?]]]]. pose proof (graph_has_gen_O g). entailer!. split.
    + red. intros. omega.
  ...
  - cbv beta. Intros g' roots' t_info'. unfold thread_info_rep. Intros.
    ...
    + assert (0 <= i + 1 < Zlength (spaces (ti_heap t_info'))) by omega.
      (* pose proof (space_start_isptr *)
      (* * rewrite Znth_map. unfold space_tri. entailer!. *)
Abort.
