...
Module Info.
  ...
  Definition source_file := "CertiGC/data_at_test.c"%string.
...
Definition _fiddle : ident := 57%positive.
...
Definition _sum : ident := 53%positive.
Definition _tagword : ident := 56%positive.
          ...
          (Sloop
            (Ssequence
              ...
              (Ssequence
                ...
                (Sset _sum
                  (Ebinop Oadd (Etempvar _sum tuint) (Etempvar _t'1 tuint)
                    tuint))))
            (Sset _i
...
((___builtin_bswap64,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_fiddle, Gfun(Internal f_fiddle)) :: nil).

Definition public_idents : list ident :=
(_fiddle :: ___builtin_debug :: ___builtin_write32_reversed ::
