...
Module Info.
  ...
  Definition source_file := "CertiGC/data_at_test.c".
...
Definition _fiddle : ident := $"fiddle".
Definition _i : ident := $"i".
Definition _main : ident := $"main".
Definition _p : ident := $"p".
Definition _size : ident := $"size".
Definition _sum : ident := $"sum".
Definition _tagword : ident := $"tagword".
...
(_fiddle :: ___builtin_debug :: ___builtin_fmin :: ___builtin_fmax ::
