...
Lemma precise_ocon_self {A} {JA: Join A} {PA: Perm_alg A} {SA: Sep_alg A}
      {AG : ageable A} {AA : Age_alg A} {DA: Disj_alg A}:
  forall P, precise P -> P = ocon P P.
Proof.
  intros. apply pred_ext.
  - apply ocon_contain_i. repeat intro.
...
Lemma disj_ocon_right_i {A: Type} {JA: Join A} {SA: Sep_alg A} {PA : Perm_alg A} {CrA: Cross_alg A} {TA: Trip_alg A} {AG : ageable A} {AA : Age_alg A}:
