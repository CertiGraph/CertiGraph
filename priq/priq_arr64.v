...
Module Info.
  ...
  Definition source_file := "priq/priq_arr.c".
...
Definition f_init := {|
  ...
  fn_vars := nil;
  fn_temps := ((_pq, (tptr tint)) :: (_t'1, (tptr tvoid)) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Scall (Some _t'1)
  ...
  (Sreturn (Some (Etempvar _pq (tptr tint)))))
|}.

Definition f_push := {|
  fn_return := tvoid;
  fn_callconv := cc_default;
  fn_params := ((_vertex, tint) :: (_weight, tint) :: (_pq, (tptr tint)) ::
                nil);
  fn_vars := nil;
  fn_temps := nil;
  fn_body :=
(Sassign
  (Ederef
    (Ebinop Oadd (Etempvar _pq (tptr tint)) (Etempvar _vertex tint)
...
((___compcert_va_int32,
 ...
 (_pq_emp, Gfun(Internal f_pq_emp)) :: (_freePQ, Gfun(Internal f_freePQ)) ::
 nil).

Definition public_idents : list ident :=
(_freePQ :: _pq_emp :: _adjustWeight :: _popMin :: _push :: _init ::
 _mallocN :: _free :: ___builtin_debug :: ___builtin_fmin ::
