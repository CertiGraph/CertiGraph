...
Module Info.
  ...
  Definition source_file := "matrix_read.c"%string.
...
Definition _getCell : ident := 55%positive.
Definition _graph : ident := 52%positive.
...
((___builtin_bswap64,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_getCell, Gfun(Internal f_getCell)) :: nil).

Definition public_idents : list ident :=
(_getCell :: ___builtin_debug :: ___builtin_write32_reversed ::
