...
Definition _argc : ident := 119%positive.
Definition _argv : ident := 120%positive.
Definition _arr : ident := 65%positive.
Definition _capacity : ident := 5%positive.
Definition _cells : ident := 76%positive.
Definition _cost : ident := 117%positive.
Definition _curr : ident := 106%positive.
Definition _data : ident := 3%positive.
Definition _dijkstra : ident := 118%positive.
Definition _dist : ident := 109%positive.
...
Definition _getCell : ident := 114%positive.
Definition _getPaths : ident := 112%positive.
Definition _graph : ident := 96%positive.
Definition _heap_cells : ident := 7%positive.
Definition _i : ident := 88%positive.
Definition _i_ptr : ident := 115%positive.
Definition _inf : ident := 97%positive.
...
Definition _keys : ident := 116%positive.
...
Definition _prev : ident := 107%positive.
Definition _printPath : ident := 108%positive.
Definition _print_graph : ident := 105%positive.
Definition _printf : ident := 94%positive.
Definition _priority : ident := 2%positive.
Definition _rand : ident := 92%positive.
Definition _random : ident := 98%positive.
Definition _remove_min_nc : ident := 84%positive.
Definition _setup : ident := 99%positive.
Definition _sink : ident := 74%positive.
Definition _size : ident := 87%positive.
Definition _srand : ident := 93%positive.
Definition _src : ident := 100%positive.
...
Definition _time : ident := 95%positive.
Definition _u : ident := 113%positive.
Definition _t'1 : ident := 121%positive.
Definition _t'10 : ident := 130%positive.
Definition _t'11 : ident := 131%positive.
Definition _t'12 : ident := 132%positive.
Definition _t'2 : ident := 122%positive.
Definition _t'3 : ident := 123%positive.
Definition _t'4 : ident := 124%positive.
Definition _t'5 : ident := 125%positive.
Definition _t'6 : ident := 126%positive.
Definition _t'7 : ident := 127%positive.
Definition _t'8 : ident := 128%positive.
Definition _t'9 : ident := 129%positive.
