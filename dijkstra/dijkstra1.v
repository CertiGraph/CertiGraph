...
Definition ___stringlit_1 : ident := 104%positive.
Definition ___stringlit_2 : ident := 105%positive.
Definition ___stringlit_3 : ident := 106%positive.
Definition ___stringlit_4 : ident := 107%positive.
Definition ___stringlit_5 : ident := 113%positive.
Definition ___stringlit_6 : ident := 114%positive.
...
Definition _getCell : ident := 117%positive.
Definition _getPaths : ident := 115%positive.
...
Definition _i : ident := 100%positive.
Definition _i_ptr : ident := 118%positive.
...
Definition _key : ident := 85%positive.
Definition _key_table : ident := 86%positive.
...
Definition _pq_edit_priority : ident := 95%positive.
Definition _pq_free : ident := 83%positive.
Definition _pq_insert : ident := 93%positive.
Definition _pq_make : ident := 97%positive.
Definition _pq_remove_min : ident := 94%positive.
Definition _pq_size : ident := 96%positive.
Definition _prev : ident := 110%positive.
Definition _printPath : ident := 111%positive.
Definition _print_graph : ident := 108%positive.
Definition _printf : ident := 91%positive.
Definition _priority : ident := 1%positive.
Definition _rand : ident := 89%positive.
Definition _random : ident := 101%positive.
Definition _remove_min : ident := 78%positive.
Definition _remove_min_nc : ident := 73%positive.
Definition _setup : ident := 102%positive.
Definition _sink : ident := 69%positive.
Definition _size : ident := 66%positive.
Definition _size__1 : ident := 74%positive.
Definition _srand : ident := 90%positive.
Definition _src : ident := 103%positive.
...
Definition _time : ident := 92%positive.
Definition _u : ident := 116%positive.
