...
Module Info.
  ...
  Definition source_file := "dijkstra/dijkstra1.c".
...
Definition f_setup := {|
  ...
  fn_temps := ((_i, tint) :: (_j, tint) :: (_random, tint) :: (_t'4, tint) ::
               (_t'3, tint) :: (_t'2, tint) :: (_t'1, tlong) ::
               (_t'5, (tptr tint)) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
            ...
            (Ssequence
              (Scall (Some _t'4)
                ...
                ((Ebinop Omul (Etempvar _size tint)
                   (Esizeof (tptr tint) tulong) tulong) :: nil))
...
(_main :: _dijkstra :: _getCell :: _getPaths :: _printPath :: _print_graph ::
 ...
 _printf :: _srand :: _rand :: _malloc :: _free :: ___builtin_debug ::
