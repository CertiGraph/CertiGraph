...
Definition ___stringlit_1 : ident := 90%positive.
Definition ___stringlit_2 : ident := 91%positive.
Definition ___stringlit_3 : ident := 92%positive.
Definition ___stringlit_4 : ident := 93%positive.
Definition ___stringlit_5 : ident := 99%positive.
...
Definition _cost : ident := 101%positive.
Definition _curr : ident := 95%positive.
Definition _dijkstra : ident := 102%positive.
Definition _dist : ident := 98%positive.
Definition _getPaths : ident := 100%positive.
...
Definition _prev : ident := 96%positive.
Definition _prim : ident := 82%positive.
Definition _printPath : ident := 97%positive.
Definition _print_graph : ident := 94%positive.
Definition _printf : ident := 85%positive.
Definition _push : ident := 55%positive.
Definition _r : ident := 71%positive.
Definition _rand : ident := 83%positive.
Definition _random : ident := 87%positive.
Definition _setup : ident := 88%positive.
Definition _srand : ident := 84%positive.
Definition _src : ident := 89%positive.
Definition _time : ident := 86%positive.
