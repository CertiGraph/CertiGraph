...
Definition ___stringlit_3 : ident := 75%positive.
Definition ___stringlit_4 : ident := 76%positive.
Definition ___stringlit_5 : ident := 82%positive.
Definition _adjustWeight : ident := 61%positive.
Definition _argc : ident := 87%positive.
Definition _argv : ident := 88%positive.
Definition _cost : ident := 85%positive.
Definition _curr : ident := 78%positive.
Definition _dijkstra : ident := 86%positive.
Definition _dist : ident := 81%positive.
Definition _getPaths : ident := 83%positive.
Definition _graph : ident := 68%positive.
...
Definition _prev : ident := 79%positive.
Definition _printPath : ident := 80%positive.
Definition _print_graph : ident := 77%positive.
Definition _printf : ident := 66%positive.
Definition _push : ident := 55%positive.
Definition _rand : ident := 64%positive.
Definition _random : ident := 70%positive.
Definition _setup : ident := 71%positive.
Definition _srand : ident := 65%positive.
Definition _src : ident := 72%positive.
Definition _time : ident := 67%positive.
Definition _u : ident := 84%positive.
