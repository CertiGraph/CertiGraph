...
Module Info.
  ...
  Definition source_file := "minexample.c"%string.
...
Definition _minexample : ident := 52%positive.

Definition f_minexample := {|
  fn_return := tint;
...
((___builtin_bswap,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=true; cc_unproto:=false; cc_structret:=false|})) ::
 (_minexample, Gfun(Internal f_minexample)) :: nil).

Definition public_idents : list ident :=
(_minexample :: ___builtin_debug :: ___builtin_nop ::
